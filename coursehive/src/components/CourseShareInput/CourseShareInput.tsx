...
import { Avatar } from '..'
import { StyledCourseShareInput } from '.'

const CourseShareInput: FC = () => {
  ...
  return (
    <form onSubmit={e => handleSubmit(e)}>
      <StyledCourseShareInput htmlFor="share-input" color={theme}>
      ...
      </StyledCourseShareInput>
    </form>
  )
}

export default CourseShareInput
